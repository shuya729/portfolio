...
export const appImageGalleries: Record<AppImageToolName, AppImageGallery> = {
	"show-personal-projects-images": {
		...
		images: [
			...
			{
				src: "/images/focory/AppStore%20SS%201%20-%20Intro.png",
				alt: "Focory のイントロ画面",
				width: 1284,
				height: 2778,
				displayWidth: 180,
	...
	"show-focory-images": {
		...
		images: [
			...
			{
				src: "/images/focory/AppStore%20SS%202%20-%20Timer.png",
				alt: "Focory の集中タイマー画面",
				width: 1284,
				height: 2778,
				displayWidth: 180,
				displayHeight: 389,
			...
			{
				src: "/images/focory/AppStore%20SS%203%20-%20Log.png",
				alt: "Focory の学習ログ画面",
				width: 1284,
				height: 2778,
				displayWidth: 180,
			...
			{
				src: "/images/focory/AppStore%20SS%204%20-%20Settings.png",
				alt: "Focory の設定画面",
				width: 1284,
				height: 2778,
				displayWidth: 180,
